/*******************************************************************************
 * EMF Specific API of the lrbac.userOperation pattern
...
import incQueryPatterns.signatures.lrbac.UserOperationSignature;

/**
 * Generated domain-specific pattern matcher API of of the lrbac.userOperation pattern.
...
public class UserOperationMatcher extends BaseGeneratedMatcher<UserOperationSignature> implements IncQueryMatcher<UserOperationSignature>{
	...
	private UserOperationMatcher(ReteEngine<String> engine) throws IncQueryRuntimeException {
		super(engine, "lrbac.userOperation");
	}
