 ...
 * <ul>
 *   <li>{@link rbac.User#getAssignedRoles <em>Assigned Roles</em>}</li>
 *   <li>{@link rbac.User#getDelegations <em>Delegations</em>}</li>
 *   <li>{@link rbac.User#getSession <em>Session</em>}</li>
 * </ul>
 * </p>
 *
 * @see rbac.RbacPackage#getUser()
 * @model
 * @generated
 */
public interface User extends PolicyElement {
	 ...
	 * @see rbac.RbacPackage#getUser_AssignedRoles()
	 * @model
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link rbac.User}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see rbac.RbacPackage#getUser_Delegations()
	 * @model
	 * @generated
	 */
	 ...
	 * @see rbac.RbacPackage#getUser_Session()
	 * @model
	 * @generated
	 */
	Session getSession();
	...
	/**
	 * Sets the value of the '{@link rbac.User#getSession <em>Session</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
