 ...
 * <ul>
 *   <li>{@link rbac.rbac.impl.PermissionImpl#getOperations <em>Operations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PermissionImpl extends PolicyElementImpl implements Permission {
	...
	public EList<Operation> getOperations() {
		if (operations == null) {
			operations = new EObjectContainmentEList<Operation>(Operation.class, this, RbacPackage.PERMISSION__OPERATIONS);
		}
		return operations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RbacPackage.PERMISSION__OPERATIONS:
