 ...
 */
package org.kevoree.experiment.ksecu.utils;
...
public class KevScriptLoader {
     ...
     * @return
     */
    public static ContainerRoot getModelFile(String path_file) throws KevScriptEngineException {
    ...
    public static ContainerRoot getModel(String kevScript) throws KevScriptEngineException {
