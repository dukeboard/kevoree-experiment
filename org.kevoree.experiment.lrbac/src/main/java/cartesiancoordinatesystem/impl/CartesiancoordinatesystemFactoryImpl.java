...
public class CartesiancoordinatesystemFactoryImpl extends EFactoryImpl implements CartesiancoordinatesystemFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CartesiancoordinatesystemPackage.CARTESIAN_COORDINATE_SYSTEM_EDITOR: return createCartesianCoordinateSystemEditor();
			default:
	 ...
	 * @generated
	 */
	public CartesianCoordinateSystemEditor createCartesianCoordinateSystemEditor() {
		CartesianCoordinateSystemEditorImpl cartesianCoordinateSystemEditor = new CartesianCoordinateSystemEditorImpl();
		return cartesianCoordinateSystemEditor;
	}
