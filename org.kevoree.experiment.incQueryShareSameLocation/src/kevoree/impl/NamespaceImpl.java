 ...
 * <ul>
 *   <li>{@link kevoree.impl.NamespaceImpl#getChilds <em>Childs</em>}</li>
 *   <li>{@link kevoree.impl.NamespaceImpl#getParent <em>Parent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NamespaceImpl extends NamedElementImpl implements Namespace {
	...
	protected EClass eStaticClass() {
		return KevoreePackage.Literals.NAMESPACE;
	}
	...
	public EList<Namespace> getChilds() {
		if (childs == null) {
			childs = new EObjectContainmentEList<Namespace>(Namespace.class, this, KevoreePackage.NAMESPACE__CHILDS);
		}
		return childs;
	}
		...
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KevoreePackage.NAMESPACE__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	...
	public void setParent(Namespace newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KevoreePackage.NAMESPACE__PARENT, oldParent, parent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KevoreePackage.NAMESPACE__CHILDS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KevoreePackage.NAMESPACE__CHILDS:
				return getChilds();
			case KevoreePackage.NAMESPACE__PARENT:
