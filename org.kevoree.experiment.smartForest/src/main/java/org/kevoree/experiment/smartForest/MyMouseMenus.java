...
public class MyMouseMenus {
    ...
    public static class CommunicationSizeDisplay extends JMenuItem implements EdgeMenuListener<GraphElements.MyEdge> {
    ...
    public static class CommunicationCostDisplay extends JMenuItem implements EdgeMenuListener<GraphElements.MyEdge> {
        public void setEdgeAndView(GraphElements.MyEdge e, VisualizationViewer visComp) {
    ...
    public static class FrequencyDisplay extends JMenuItem implements VertexMenuListener<GraphElements.MyVertex> {
        public void setVertexAndView(GraphElements.MyVertex e, VisualizationViewer visComp) {
            this.setText("Frequency " + e + " = " + e.getFrequency());
        }
    }

    public static class PowerDisplay extends JMenuItem implements VertexMenuListener<GraphElements.MyVertex> {
        public void setVertexAndView(GraphElements.MyVertex e, VisualizationViewer visComp) {
            this.setText("Power " + e + " = " + e.getPower());
        }
    }

    public static class DataCollectorDisplay extends JMenuItem implements VertexMenuListener<GraphElements.MyVertex> {
        public void setVertexAndView(GraphElements.MyVertex e, VisualizationViewer visComp) {
