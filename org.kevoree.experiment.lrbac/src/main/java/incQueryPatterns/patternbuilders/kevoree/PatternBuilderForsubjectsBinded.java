...
public class PatternBuilderForsubjectsBinded implements IStatelessGeneratedRetePatternBuilder {
	...
	public Address<? extends Receiver> construct(
		...
		final Address<? extends Receiver> var_0 = buildable.patternCollector("enforcementInfo.subjectsBinded");
		...
		final Object var_19 = ((EClass) (EPackage.Registry.INSTANCE.getEPackage("http://kevoree/1.0").getEClassifier("ComponentInstance"))).getEStructuralFeature("required");
		final Stub<Address<? extends Supplier>> var_20 = buildable.binaryEdgeTypeStub(new FlatTuple(new Object[] {"C", "P"}), var_19);
		...
		final Stub<Address<? extends Supplier>> var_29 = buildable.binaryEdgeTypeStub(new FlatTuple(new Object[] {"B", "P"}), var_28);
		...
		final Stub<Address<? extends Supplier>> var_39 = buildable.binaryEdgeTypeStub(new FlatTuple(new Object[] {"B", "CHA"}), var_38);
		...
		final Stub<Address<? extends Supplier>> var_45 = buildable.buildInjectivityChecker(var_44, 2, new int[] {5});
		...
		final TupleMask var_49 = new TupleMask(new int[] {2}, 6);
		final Stub<Address<? extends Supplier>> var_50 = buildable.buildTrimmer(var_48, var_49);
		buildable.buildConnection(var_50, var_0);
		return var_0;
