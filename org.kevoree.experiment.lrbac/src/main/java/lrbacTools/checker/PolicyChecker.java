...
public class PolicyChecker {
	...
	public static void main(String[] args) {
		Policy policy = LrbacFactoryImpl.eINSTANCE.createPolicy();
		PolicyGenerator policyGenerator = new PolicyGenerator(policy);
		policyGenerator.generate(3, 3, 3, 3, 3, 3, false, false, false, false, false, false);
		Chrono c = new Chrono();
		c.start();
