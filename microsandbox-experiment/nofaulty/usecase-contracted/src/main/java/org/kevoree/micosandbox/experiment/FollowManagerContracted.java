...
import org.daum.library.javase.copterManager.FollowManager;
 ...
 */
@ComponentType
public class FollowManagerContracted extends FollowManager implements CPUContracted,MemoryContracted,NetworkContracted,ThroughputContracted {
}
