...
public class LrbacSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case LrbacPackage.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = casePolicyElement(constraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LrbacPackage.LOCATION: {
				...
				if (result == null) result = caseConstraint(location);
				if (result == null) result = casePolicyElement(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
