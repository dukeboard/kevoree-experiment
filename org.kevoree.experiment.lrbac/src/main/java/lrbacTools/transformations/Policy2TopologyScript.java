...
import patternbuilders.lrbac.PatternBuilderForOperationObjectAssignment;
import patternbuilders.lrbac.PatternBuilderForPermissionOperationAssignment;
import patternbuilders.lrbac.PatternBuilderForRolePermissionAssignment;
import patternbuilders.lrbac.PatternBuilderForobject;
import patternbuilders.lrbac.PatternBuilderForoperation;
import patternbuilders.lrbac.PatternBuilderForpermission;
import patternbuilders.lrbac.PatternBuilderForrole;
import patternbuilders.lrbac.PatternBuilderForsession;
import patternbuilders.lrbac.PatternBuilderForuser;
import patternbuilders.lrbac.PatternBuilderForuserOperation;
import patternbuilders.lrbac.PatternBuilderForuserRoleAssignment;
import patternbuilders.lrbac.PatternBuilderForuserRule;
import patternmatchers.lrbac.ObjectMatcher;
import patternmatchers.lrbac.OperationMatcher;
import patternmatchers.lrbac.OperationObjectAssignmentMatcher;
import patternmatchers.lrbac.PermissionMatcher;
import patternmatchers.lrbac.PermissionOperationAssignmentMatcher;
import patternmatchers.lrbac.RoleMatcher;
import patternmatchers.lrbac.RolePermissionAssignmentMatcher;
import patternmatchers.lrbac.SessionMatcher;
import patternmatchers.lrbac.UserMatcher;
import patternmatchers.lrbac.UserOperationMatcher;
import patternmatchers.lrbac.UserRoleAssignmentMatcher;
import patternmatchers.lrbac.UserRuleMatcher;
import signatures.lrbac.ObjectSignature;
import signatures.lrbac.OperationObjectAssignmentSignature;
import signatures.lrbac.OperationSignature;
import signatures.lrbac.PermissionOperationAssignmentSignature;
import signatures.lrbac.PermissionSignature;
import signatures.lrbac.RolePermissionAssignmentSignature;
import signatures.lrbac.RoleSignature;
import signatures.lrbac.SessionSignature;
import signatures.lrbac.UserOperationSignature;
import signatures.lrbac.UserRoleAssignmentSignature;
import signatures.lrbac.UserRuleSignature;
import signatures.lrbac.UserSignature;
import lrbac.Object;
...
public class Policy2TopologyScript {
	...
	public Policy2TopologyScript(Policy p) {
		policy = p;
