...
public class CartesiancoordinatesystemAdapterFactory extends AdapterFactoryImpl {
	...
	protected CartesiancoordinatesystemSwitch<Adapter> modelSwitch =
		new CartesiancoordinatesystemSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCartesianCoordinateSystemEditor(CartesianCoordinateSystemEditor object) {
				return createCartesianCoordinateSystemEditorAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link cartesiancoordinatesystem.CartesianCoordinateSystemEditor <em>Cartesian Coordinate System Editor</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCartesianCoordinateSystemEditorAdapter() {
		return null;
	}
