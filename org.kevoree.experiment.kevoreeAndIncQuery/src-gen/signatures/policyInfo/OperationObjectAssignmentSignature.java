/*******************************************************************************
 * Pattern signature of the policyInfo.OperationObjectAssignment pattern
...
/**
 * Pattern-specific signature object of the policyInfo.OperationObjectAssignment pattern.
...
public final class OperationObjectAssignmentSignature extends BasePatternSignature implements IPatternSignature {

	// constructor
	public OperationObjectAssignmentSignature(Object PERM, Object OPE, Object OBJ) {
		this.fPERM = PERM;
		this.fOPE = OPE;
		this.fOBJ = OBJ;	
	}
	...
	public Object get(String parameterName) {
		...
		if ("OBJ".equals(parameterName)) return fOBJ;
		return null;
	}	
	...
	public void setValueOfOBJ(Object OBJ){
		 this.fOBJ=OBJ;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!patternName().equals(otherSig.patternName()))
			return false;
		if (!OperationObjectAssignmentSignature.class.equals(obj.getClass()))
			return Arrays.deepEquals(toArray(), otherSig.toArray());
		OperationObjectAssignmentSignature other = (OperationObjectAssignmentSignature) obj;
		...
		if (fOBJ == null) {if (other.fOBJ != null) return false;}
		else if (!fOBJ.equals(other.fOBJ)) return false;
		return true;
	}
	...
	public Object[] toArray() {
		return new Object[] {fPERM, fOPE, fOBJ};
	}
	
	/** Identifies the name of the pattern for which this is a signature. */
	@Override
	public String patternName() {
		return "policyInfo.OperationObjectAssignment";
	}
	...
	private static String[] parameterNames = {"PERM", "OPE", "OBJ"};
