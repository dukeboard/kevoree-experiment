/*******************************************************************************
 * Pattern signature of the enforcementInfo.subjectComponent pattern
...
/**
 * Pattern-specific signature object of the enforcementInfo.subjectComponent pattern.
...
public final class SubjectComponentSignature extends BasePatternSignature implements IPatternSignature {

	// constructor
	public SubjectComponentSignature(Object C) {
		this.fC = C;	
	}
	...
	public boolean equals(Object obj) {
		...
		if (!patternName().equals(otherSig.patternName()))
			return false;
		if (!SubjectComponentSignature.class.equals(obj.getClass()))
			return Arrays.deepEquals(toArray(), otherSig.toArray());
		SubjectComponentSignature other = (SubjectComponentSignature) obj;
