...
public class LrbacPackageImpl extends EPackageImpl implements LrbacPackage {
	 ...
	 * @generated
	 */
	public EReference getPermission_Constraints() {
	 ...
	 * @generated
	 */
	public EReference getConstraint_Permissions() {
	...
	public void createPackageContents() {
		...
		createEReference(permissionEClass, PERMISSION__CONSTRAINTS);
		...
		createEReference(constraintEClass, CONSTRAINT__PERMISSIONS);
	...
	public void initializePackageContents() {
		...
		constraintEClass.getESuperTypes().add(this.getPolicyElement());
		locationEClass.getESuperTypes().add(this.getConstraint());
		...
		initEReference(getPermission_Constraints(), this.getConstraint(), this.getConstraint_Permissions(), "constraints", null, 0, -1, Permission.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(objectEClass, lrbac.Object.class, "Object", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getObject_Operations(), this.getOperation(), this.getOperation_Objects(), "operations", null, 0, -1, lrbac.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConstraint_Permissions(), this.getPermission(), this.getPermission_Constraints(), "permissions", null, 0, -1, Constraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
