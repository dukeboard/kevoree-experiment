/*******************************************************************************
 * EMF Specific API of the lrbac.OperationObjectAssignment pattern
...
import incQueryPatterns.signatures.lrbac.OperationObjectAssignmentSignature;

/**
 * Generated domain-specific pattern matcher API of of the lrbac.OperationObjectAssignment pattern.
...
public class OperationObjectAssignmentMatcher extends BaseGeneratedMatcher<OperationObjectAssignmentSignature> implements IncQueryMatcher<OperationObjectAssignmentSignature>{
	...
	private OperationObjectAssignmentMatcher(ReteEngine<String> engine) throws IncQueryRuntimeException {
		super(engine, "lrbac.OperationObjectAssignment");
	}
