...
public class RbacFactoryImpl extends EFactoryImpl implements RbacFactory {
	...
	public static RbacFactory init() {
		try {
			RbacFactory theRbacFactory = (RbacFactory)EPackage.Registry.INSTANCE.getEFactory("rbac.rbac"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case RbacPackage.POLICY: return createPolicy();
			...
			case RbacPackage.OPERATION: return createOperation();
			case RbacPackage.RESOURCE: return createResource();
