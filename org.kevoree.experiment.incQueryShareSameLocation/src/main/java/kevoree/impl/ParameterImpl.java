 ...
 * <ul>
 *   <li>{@link kevoree.impl.ParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends NamedElementImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return KevoreePackage.Literals.PARAMETER;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KevoreePackage.PARAMETER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(TypedElement newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KevoreePackage.PARAMETER__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KevoreePackage.PARAMETER__TYPE:
