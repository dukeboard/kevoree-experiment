/*******************************************************************************
 * EMF Specific API of the enforcementInfo.channel pattern
...
import incQueryPatterns.signatures.kevoree.ChannelSignature;

/**
 * Generated domain-specific pattern matcher API of of the enforcementInfo.channel pattern.
...
public class ChannelMatcher extends BaseGeneratedMatcher<ChannelSignature> implements IncQueryMatcher<ChannelSignature>{
	 ...
	 */
	public Collection<ChannelSignature> getAllMatchesAsSignature(Object C) {
	 ...
	 */
	public ChannelSignature getOneMatchAsSignature(Object C) {
	...
	private ChannelMatcher(ReteEngine<String> engine) throws IncQueryRuntimeException {
		super(engine, "enforcementInfo.channel");
	}
