 ...
 *   <li>{@link grapho.impl.GraphOImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GraphOImpl extends EObjectImpl implements GraphO {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphoPackage.GRAPH_O__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphoPackage.GRAPH_O__ELEMENTS:
				return getElements();
			case GraphoPackage.GRAPH_O__NAME:
				return getName();
		}
