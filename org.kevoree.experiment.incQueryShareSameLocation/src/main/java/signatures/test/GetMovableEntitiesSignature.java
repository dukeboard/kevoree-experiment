/*******************************************************************************
 * Pattern signature of the test.getMovableEntities pattern
...
/**
 * Pattern-specific signature object of the test.getMovableEntities pattern.
...
public final class GetMovableEntitiesSignature extends BasePatternSignature implements IPatternSignature {

	// constructor
	public GetMovableEntitiesSignature(Object N, Object C) {
		this.fN = N;
		this.fC = C;	
	}
	...
	public boolean equals(Object obj) {
		...
		if (!patternName().equals(otherSig.patternName()))
			return false;
		if (!GetMovableEntitiesSignature.class.equals(obj.getClass()))
			return Arrays.deepEquals(toArray(), otherSig.toArray());
		GetMovableEntitiesSignature other = (GetMovableEntitiesSignature) obj;
