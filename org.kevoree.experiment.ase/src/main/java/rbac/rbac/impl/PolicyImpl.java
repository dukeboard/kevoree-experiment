 ...
 * <ul>
 *   <li>{@link rbac.rbac.impl.PolicyImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PolicyImpl extends EObjectImpl implements Policy {
	...
	public EList<PolicyElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<PolicyElement>(PolicyElement.class, this, RbacPackage.POLICY__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RbacPackage.POLICY__ELEMENTS:
