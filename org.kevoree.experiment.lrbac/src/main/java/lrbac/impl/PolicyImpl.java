 ...
 * <ul>
 *   <li>{@link lrbac.impl.PolicyImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PolicyImpl extends PolicyElementImpl implements Policy {
	...
	protected EClass eStaticClass() {
		return LrbacPackage.Literals.POLICY;
	}
	...
	public EList<PolicyElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<PolicyElement>(PolicyElement.class, this, LrbacPackage.POLICY__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LrbacPackage.POLICY__ELEMENTS:
