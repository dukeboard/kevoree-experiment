/*******************************************************************************
 * Pattern signature of the policyInfo.userOperation pattern
...
/**
 * Pattern-specific signature object of the policyInfo.userOperation pattern.
...
public final class UserOperationSignature extends BasePatternSignature implements IPatternSignature {

	// constructor
	public UserOperationSignature(Object USER, Object OPERATIONNAME) {
		this.fUSER = USER;
	...
	public Object get(String parameterName) {
		...
		if ("OPERATIONNAME".equals(parameterName)) return fOPERATIONNAME;
		return null;
	}	
	...
	public Object getValueOfOPERATIONNAME(){
	...
	public void setValueOfOPERATIONNAME(Object OPERATIONNAME){
		 this.fOPERATIONNAME=OPERATIONNAME;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!patternName().equals(otherSig.patternName()))
			return false;
		if (!UserOperationSignature.class.equals(obj.getClass()))
			return Arrays.deepEquals(toArray(), otherSig.toArray());
		UserOperationSignature other = (UserOperationSignature) obj;
	...
	public Object[] toArray() {
		return new Object[] {fUSER, fOPERATIONNAME};
	}
	
	/** Identifies the name of the pattern for which this is a signature. */
	@Override
	public String patternName() {
		return "policyInfo.userOperation";
	}
	...
	private static String[] parameterNames = {"USER", "OPERATIONNAME"};
