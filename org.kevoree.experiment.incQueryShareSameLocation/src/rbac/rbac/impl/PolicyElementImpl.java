 ...
 * <ul>
 *   <li>{@link rbac.rbac.impl.PolicyElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PolicyElementImpl extends EObjectImpl implements PolicyElement {
	...
	protected EClass eStaticClass() {
		return RbacPackage.Literals.POLICY_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RbacPackage.POLICY_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RbacPackage.POLICY_ELEMENT__NAME:
				return getName();
		}
