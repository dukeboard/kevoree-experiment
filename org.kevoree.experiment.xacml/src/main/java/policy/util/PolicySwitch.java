...
public class PolicySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PolicyPackage.POLICY_EDITOR: {
				PolicyEditor policyEditor = (PolicyEditor)theEObject;
				T result = casePolicyEditor(policyEditor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePolicyEditor(PolicyEditor object) {
		return null;
	}
