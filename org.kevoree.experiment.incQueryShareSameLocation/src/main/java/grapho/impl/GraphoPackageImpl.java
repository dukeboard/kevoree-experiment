...
public class GraphoPackageImpl extends EPackageImpl implements GraphoPackage {
	 ...
	 * @generated
	 */
	public EAttribute getGraphO_Name() {
		return (EAttribute)graphOEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(graphOEClass, GRAPH_O__NAME);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGraphO_Name(), ecorePackage.getEString(), "name", null, 1, 1, GraphO.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
