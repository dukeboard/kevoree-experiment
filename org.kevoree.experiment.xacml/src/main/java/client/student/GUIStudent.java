...
public class GUIStudent extends javax.swing.JFrame {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		parent.getPortByName("request", MessagePort.class).process("student"+":"+parent.getName()+":"+jComboBox1.getSelectedItem().toString()+":"+jTextArea1.getText());
	}
